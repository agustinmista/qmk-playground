...
[_BASE] = LAYOUT_preonic_2x2u(
  ...
  KC_LCTL, KC_LGUI, BASE,    KC_LALT,  LT_LWR(KC_SPC),   LT_RSE(KC_ENT),  KC_RALT, QK_LEAD, KC_DOWN, KC_UP
),

[_LOWER] = LAYOUT_preonic_2x2u(
  KC_TILD,     KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
  LCA(KC_F13), KC_F1,   KC_F2,   KC_F3,   KC_F4,   XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
  LCA(KC_F14), KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, XXXXXXX, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DQUO,
