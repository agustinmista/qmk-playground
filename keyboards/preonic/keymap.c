...
[_BASE] = LAYOUT_preonic_2x2u(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, OSM(KC_LSFT),
...
[_LOWER] = LAYOUT_preonic_2x2u(
  ...
  _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_QUES, OSM(KC_LSFT),
